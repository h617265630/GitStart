            ...
            <div class="am-tabs am-margin" data-am-tabs>
                ...
                <div class="am-tabs-bd">
                    <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                        <form class="am-form" method="post" action="{{url('admin/nav')}}">
                            {{csrf_field()}}
                            ...
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-4">
                                    <input type="text" name="nav_name" class="am-input-sm">
                                </div>
                            ...
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                    <input type="text"  name="nav_alias" class="am-input-sm">
                                </div>
                                <div class="am-hide-sm-only am-u-md-6">*必填</div>
                            </div>
                            ...
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                    <input type="text"  name="nav_url" class="am-input-sm">
                                </div>
                                <div class="am-hide-sm-only am-u-md-6">*必填</div>
                            </div>
                            ...
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                    <input type="text"  name="nav_order" class="am-input-sm" >
                                </div>
                            </div>
